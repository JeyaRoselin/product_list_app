...
import 'package:product_list_app/controller/constants/my_observer.dart';
...
import 'package:product_list_app/controller/router/app_router.dart';

import 'controller/cubits/product_list_cubit.dart';
      ...
      providers: [
        ...
        providers: [
          BlocProvider<ProductSearchCubit>(
            create: (repoContext) => ProductSearchCubit(authRepository:AuthRepository(apiService))),
